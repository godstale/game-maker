...
uint8_t InputController::getInput() {
	...
	else if (x_move > RIGHT_THRESHOLD) { value = value | B00001000; }	// right

	if (y_move > UP_THRESHOLD) { value = value | B00010000; }	// up
	else if (y_move < DOWN_THRESHOLD) { value = value | B00000100; }	// down
//	if (y_move > UP_THRESHOLD) { value = value | B00000100; }	// up
//	else if (y_move < DOWN_THRESHOLD) { value = value | B00010000; }	// down
